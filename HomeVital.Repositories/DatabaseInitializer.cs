        ...
        public static void Initialize(HomeVitalDbContext context)
        {
            ...
            if (!context.Bloodsugars.Any())
            {
                context.Bloodsugars.AddRange(
                    ...
                    new Bloodsugar { PatientID = 1, BloodsugarLevel = 2.5f, Date = DateTime.UtcNow.AddDays(-44), Status = "Normal" },
                    ...
                    new Bloodsugar { PatientID = 1, BloodsugarLevel = 6.5f, Date = DateTime.UtcNow.AddDays(-14), Status = "Normal" },
                    new Bloodsugar { PatientID = 1, BloodsugarLevel = 7.5f, Date = DateTime.UtcNow.AddDays(-13), Status = "Normal" },
