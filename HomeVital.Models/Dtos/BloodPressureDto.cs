...
namespace HomeVital.Models.Dtos
{
    public class BloodPressureDto
    {
        ...
        public required string MeasuredHand { get; set; } // which hand was used to measure the blood pressure (left, right)
        public required string BodyPosition { get; set; } // body position of the patient when the blood pressure was taken (sitting, standing, lying down)
