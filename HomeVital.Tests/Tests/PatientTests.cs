...
//             var actualPatients = JsonConvert.DeserializeObject<List<Patient>>(responseString);

//             // Assert
//             Assert.NotNull(actualPatients);
//             Assert.IsType<List<Patient>>(actualPatients);
//             Assert.NotEmpty(actualPatients);
//         }
